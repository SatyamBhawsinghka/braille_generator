...
class ArmIK:
    ...
    def transformAngelAdaptArm(self, theta3, theta4, theta5, theta6):
        #Convert the angle calculated by inverse kinematics to the pulse width value corresponding to the steering gear
    ...
    def setPitchRange(self, coordinate_data, alpha1, alpha2, da = 1):
        #Given the range of coordinates coordinate_data and pitch angle alpha1, alpha2,
        # automatically find a suitable solution within the range
        #If there is no solution, return False,
        # otherwise return the corresponding servo angle, pitch angle
    ...
    def setPitchRangeMoving(self, coordinate_data, alpha, alpha1, alpha2, movetime=None):
        ...
        # and the range of pitch angle range alpha1, alpha2,
        # automatically find the solution closest to the given pitch angle, and go to the target position
        ...
        #alpha1 and alpha2 are the range of values for the pitch angle
        #movetime is the rotation time of the servo, in ms,
        # if no time is given, it will be calculated automatically
        x, y, z = coordinate_data
